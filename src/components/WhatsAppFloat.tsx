...
const WhatsAppFloat = () => {
  ...
  return (
    <a
      ...
      /* Hidden below `sm`, where MobileActionBar owns the bottom of the screen. */
      className={`fixed bottom-6 right-6 z-40 hidden items-center gap-2.5 rounded-full bg-whatsapp py-3.5 pl-4 pr-5 text-whatsapp-foreground shadow-warm-xl transition-[transform,opacity] duration-500 ease-brand hover:scale-105 sm:flex ${
