...
const PrivacyPolicy: React.FC = () => (
  <div className="max-w-3xl mx-auto px-4 py-12">
    ...
    <h2 className="text-xl font-semibold mt-8 mb-2">7. Your Rights Under GDPR</h2>
    <ul className="list-disc ml-6 mb-4">
    ...
    <h2 className="text-xl font-semibold mt-8 mb-2">9. Transparency and Communication</h2>
    <p className="mb-4">
